...
def processedFrame(image):
    ...
    for l1, l2 in pairs:
        ...
        if warped is not None:
            ...
            black_key_properties = check_if_candidate_keyboard(warped, maxBlackKeys)
            if type(black_key_properties) == 'list':
                num_black_keys = len(black_key_properties)
            else:
                num_black_keys = black_key_properties
